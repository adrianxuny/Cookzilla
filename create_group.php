			...
			<div class="row">
				...
				<section class="content full-width">
					<div class="submit_recipe container">
						<form action="create_group_done.php" method="post">
							<section>
								<h2>Group Name</h2>
								<p>All fields are required.</p>
								<div class="f-row">
									<div class="third"><input type="text" name="groupname" placeholder="Group name" /></div>
								</div>
							</section>
							...
							<div class="f-row full">
								<input type="submit" class="button" id="submitRecipe" value="Create the group" />
							</div>
			...
			<div class="row">
				...
				<section class="content three-fourth">
					...
					<div class="row">
						<div class="two-third">
							<div class="container">
									<p>Only members can create groups.</p>
