...
$query = "INSERT INTO events(groupname, eventname, location, eventtime, description, pic)
		VALUES ('$groupname', '$eventname', '$location', '$time', '$description','$pic')";
			...
			<div class="row">
				...
				<section class="content three-fourth">
					...
					<div class="row">
						<div class="two-third">
							<div class="container">
								<p>Congratulations! Your event has been posted.</p>
							</div>
						</div>
					</div>
					<!--//row-->
